...
<section class="form-container" style="min-height: 100vh;">
   ...
   <form action="" method="POST">
      ...
      <input type="text" name="name" placeholder="enter username" maxlength="20" class="box" required oninput=" ">
      <input type="password" name="pass" placeholder="enter password" maxlength="20" class="box" required oninput="">
