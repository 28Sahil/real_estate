...
<section class="view-property">
   ...
   <?php
      ...
      if($select_properties_res){
         ...
         $select_user_query ="SELECT * FROM `users1` WHERE id = '$property_id'"  or die($conn->error);
     ...
     <div class="swiper images-container">
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i>deposit amount : </i><span><span class="fas fa-indian-rupee-sign" style="margin-right: .5rem;"></span><?php echo $fetch_property['deposite']; ?></span></p>
