...
//    print_r($_FILES);
   ...
   if($image_01_size > 2000000){
      ...
      $insert_property_query ="INSERT INTO `property`(user_id, property_name, address, price, type, offer, status, furnished, bhk, deposite, bedroom, bathroom, balcony, carpet, age, total_floors, room_floor, loan, lift, security_guard, play_ground, garden, water_supply, power_backup, parking_area, gym, shopping_mall, hospital, school, market_area, image_01, image_02, image_03, image_04, image_05, description) VALUES('$user_id', '$property_name', '$address', '$price', '$type', '$offer', '$status', '$furnished', '$bhk', '$deposite', '$bedroom', '$bathroom', '$balcony', '$carpet', '$age', '$total_floors', '$room_floor', '$loan', '$lift', '$security_guard', '$play_ground', '$garden', '$water_supply', '$power_backup', '$parking_area',' $gym', '$shopping_mall', '$hospital', '$school',' $market_area', '$image_01', '$image_02', '$image_03', '$image_04', '$image_05', '$description')" or die($con->errorss);
