...
<section class="listings">
   ...
   <div class="box-container">
      <?php
         $total_images = 0;
         $select_properties_query = "SELECT * FROM `property` ORDER BY date DESC LIMIT 6";
      ...
      <form action="" method="POST">
         <div class="box">
            ...
            <div class="admin">
               <?php
$fetch_user_query="SELECT * FROM `users1` WHERE id=' $fetch_property_user_id'" or die($conn->error);
