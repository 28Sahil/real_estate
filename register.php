...
if (isset($_POST['submit'])) {
   ...
   $select_users_query = "SELECT * FROM `users1` WHERE email = '$email'";
   ...
   if ($select_users_res->num_rows > 0) {
      ...
      if ($pass != $c_pass) {
         ...
         $insert_user_query = "INSERT INTO users1 (name, number, email, password) VALUES('$name', '$number', '$email', '$c_pass')" or die('error');
